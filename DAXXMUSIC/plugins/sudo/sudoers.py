...
async def sudoers_list(client, message: Message):
    keyboard = [[InlineKeyboardButton("💛𝐕𝐢𝐞𝐰 𝐒𝐮𝐝𝐨𝐥𝐢𝐬𝐭❤️‍🩹⚡", callback_data="check_sudo_list")]]
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("𝐕𝐚𝐚𝐩𝐢𝐥𝐥𝐚 𝐑𝐚𝐣𝐚 😸🖕👻", show_alert=True)
    else:
        ...
        keyboard.append([InlineKeyboardButton("𝐯𝐢𝐞𝐰 𝐎𝐰𝐧𝐞𝐫⚡❤️‍🩹", url=f"tg://openmessage?user_id={OWNER_ID}")])
